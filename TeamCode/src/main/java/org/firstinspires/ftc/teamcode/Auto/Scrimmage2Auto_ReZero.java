...
public class Scrimmage2Auto_ReZero extends OpMode {
    ...
    public void init() {
        ...
        linearSlides = new LinearSlide(hardwareMap, motorNames, directions, 81.5625, -20, 37.5); // Example ticksPerInch and limits
