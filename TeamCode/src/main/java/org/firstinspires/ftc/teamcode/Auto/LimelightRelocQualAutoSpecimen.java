...
@Autonomous(name = "Limelight Relocalization Qual 1 Auto Specimen")
@Disabled
public class LimelightRelocQualAutoSpecimen extends OpMode {
    ...
    public void init() {
        ...
        limelightRelocTest = new LimelightRelocTest(relocalizer, follower);
